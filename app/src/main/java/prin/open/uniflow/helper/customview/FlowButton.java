...
public class FlowButton extends Button {
    ...
    //压后 弯曲度
    private float mBezierRange = 0.4f;
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.pressureview);
            mColor = ta.getColor(R.styleable.pressureview_colors,Color.parseColor("#008cff"));
            ...
            mScaleRange = ta.getFloat(R.styleable.pressureview_scale_ranger,mScaleRange);
            if(mScaleRange<=1){
                mScaleRange = 1.2f;
            }
